unit FuelCharacteristicsCalculationCardTableDefinition;
...
const
  ...
  FUEL_CHARACTERISTICS_CALCULATION_CARD_TABLE_NAME =
    SCHEMA_NAME + '.' + 'fuel_characteristics_calculation_cards';
