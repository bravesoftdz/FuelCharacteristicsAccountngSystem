program FuelCharacteristicsAccounting;

uses
  Forms,
  BaseFuelCharacteristicsAccountingMainFormController in 'Controllers\Primary Screens\BaseFuelCharacteristicsAccountingMainFormController.pas',
  FuelCharacteristicsAccountingMainFormControllerEvents in 'Controllers\Primary Screens\FuelCharacteristicsAccountingMainFormControllerEvents.pas',
  ...
  unFuelCharacteristicsAccountingMainForm in 'Forms\Primary Screens\unFuelCharacteristicsAccountingMainForm.pas' {FuelCharacteristicsAccountingMainForm},
  ...
  BaseSystemAdministrationFormController in 'C:\Common Delphi Libs\u_59968 Delphi Modules\DDD\Presentation\Controllers\Administration\BaseSystemAdministrationFormController.pas',
  ...
  BaseSystemAdministrationFormControllerEvents in 'C:\Common Delphi Libs\u_59968 Delphi Modules\DDD\Presentation\Controllers\Administration\BaseSystemAdministrationFormControllerEvents.pas',
  ...
  unFuelCharacteristicsAccountingAdministrationForm in 'Forms\Primary Screens\unFuelCharacteristicsAccountingAdministrationForm.pas' {FuelCharacteristicsAccountingAdministrationForm},
  ...
  AbstractReferenceFormViewModelMapper in 'C:\Common Delphi Libs\u_59968 Delphi Modules\Reference Forms\View Models\Mappers\AbstractReferenceFormViewModelMapper.pas',
  ReferenceFormViewModelMapper in 'C:\Common Delphi Libs\u_59968 Delphi Modules\Reference Forms\View Models\Mappers\ReferenceFormViewModelMapper.pas',
  EmployeesReferenceFormViewModelMapper in 'View Model Mappers\References\Employees\EmployeesReferenceFormViewModelMapper.pas',
  EmployeesAdministrationReferenceFormViewModelMapper in 'View Model Mappers\References\Employees\EmployeesAdministrationReferenceFormViewModelMapper.pas',
  EmployeesAdministrationReferenceFormServiceController in 'Controllers\References\Employees\EmployeesAdministrationReferenceFormServiceController.pas',
  ...
  FullSuccessedStubSystemAuthorizationService in 'C:\Common Delphi Libs\u_59968 Delphi Modules\DDD\App Services\Authorization\Stubs\FullSuccessedStubSystemAuthorizationService.pas',
  FuelCharacteristicsAccountingSystemAdministrationFormServiceController in 'Controllers\Primary Screens\Administration\FuelCharacteristicsAccountingSystemAdministrationFormServiceController.pas',
  FuelCharacteristicsAccountingFormControllersConfigurator in 'Launching\Configuration\FuelCharacteristicsAccountingFormControllersConfigurator.pas',
  EmployeeFormControllersConfigurator in 'Launching\Configuration\EmployeeFormControllersConfigurator.pas',
  AbstractFormControllersConfigurator in 'Launching\Configuration\AbstractFormControllersConfigurator.pas',
  FuelCharacteristicsAccountingMainFormServiceController in 'Controllers\Primary Screens\FuelCharacteristicsAccountingMainFormServiceController.pas',
  ...
  SystemAuthentificationFormControllersConfigurator in 'Launching\Configuration\SystemAuthentificationFormControllersConfigurator.pas',
  BaseFuelCharacteristicsAutomaticCalculationFormController in 'Controllers\Cards\Fuel\Calculation\BaseFuelCharacteristicsAutomaticCalculationFormController.pas',
  unFuelCharacteristicsAutomaticCalculationForm in 'Forms\Cards\Fuel\Calculation\unFuelCharacteristicsAutomaticCalculationForm.pas' {FuelCharacteristicsAutomaticCalculationForm},
  FuelCharacteristicsAutomaticCalculationFormViewModel in 'Forms\Cards\Fuel\View Models\FuelCharacteristicsAutomaticCalculationFormViewModel.pas',
  FuelCharacteristicsAutomaticCalculationFormControllerEvents in 'Controllers\Cards\Fuel\Calculation\FuelCharacteristicsAutomaticCalculationFormControllerEvents.pas',
  FuelCharacteristicsAutomaticCalculationFormStubController in 'Controllers\Cards\Fuel\Calculation\FuelCharacteristicsAutomaticCalculationFormStubController.pas',
  BaseReservoirKindReferenceSuitesFormController in 'Controllers\References\Reservoir Kinds\BaseReservoirKindReferenceSuitesFormController.pas',
  unReservoirKindReferenceSuiteCardForm in 'Forms\Cards\Reservoir Kinds\unReservoirKindReferenceSuiteCardForm.pas' {ReservoirKindReferenceSuiteCardForm},
  BaseReservoirKindReferenceSuiteCardFormController in 'Controllers\Cards\Reservoir Kinds\BaseReservoirKindReferenceSuiteCardFormController.pas',
  ReservoirKindReferenceSuiteCardFormViewModel in 'Forms\Cards\Reservoir Kinds\View Models\ReservoirKindReferenceSuiteCardFormViewModel.pas',
  ReservoirKindsFormControllerEvents in 'Controllers\References\Reservoir Kinds\ReservoirKindsFormControllerEvents.pas',
  unReservoirKindsForm in 'Forms\References\Reservoir Kinds\unReservoirKindsForm.pas' {ReservoirKindsForm},
  ReservoirKindsFormViewModel in 'Forms\References\Reservoir Kinds\View Models\ReservoirKindsFormViewModel.pas',
  ReservoirKindsDataSetHolder in 'Forms\References\Reservoir Kinds\View Models\ReservoirKindsDataSetHolder.pas',
  ReservoirKindRecordViewModel in 'Forms\References\Reservoir Kinds\View Models\ReservoirKindRecordViewModel.pas',
  BaseReservoirKindsFormController in 'Controllers\References\Reservoir Kinds\BaseReservoirKindsFormController.pas',
  unReservoirKindReferenceSuitesForm in 'Forms\References\Reservoir Kinds\unReservoirKindReferenceSuitesForm.pas' {ReservoirKindReferenceSuitesForm},
  ReservoirKindReferenceSuitesFormViewModel in 'Forms\References\Reservoir Kinds\View Models\ReservoirKindReferenceSuitesFormViewModel.pas',
  ReservoirKindReferenceSuitesDataSetHolder in 'Forms\References\Reservoir Kinds\View Models\ReservoirKindReferenceSuitesDataSetHolder.pas',
  ReservoirKindReferenceSuiteRecordViewModel in 'Forms\References\Reservoir Kinds\View Models\ReservoirKindReferenceSuiteRecordViewModel.pas',
  ReservoirKindReferenceSuitesFormControllerEvents in 'Controllers\References\Reservoir Kinds\ReservoirKindReferenceSuitesFormControllerEvents.pas',
  ReservoirKindReferenceSuiteCardFormControllerEvents in 'Controllers\Cards\Reservoir Kinds\ReservoirKindReferenceSuiteCardFormControllerEvents.pas',
  ReservoirKindReferenceSuiteRecordViewModelMapper in 'View Model Mappers\References\Reservoir Kinds\ReservoirKindReferenceSuiteRecordViewModelMapper.pas',
  ReservoirKindReferenceSuiteCardFormViewModelMapper in 'View Model Mappers\Cards\Reservoir Kinds\ReservoirKindReferenceSuiteCardFormViewModelMapper.pas',
  ReservoirKindReferenceSuiteCardFormStubController in 'Controllers\Cards\Reservoir Kinds\ReservoirKindReferenceSuiteCardFormStubController.pas',
  unTestReservoirKindsDataSetModule in 'Forms\References\Reservoir Kinds\View Models\unTestReservoirKindsDataSetModule.pas' {TestReservoirKindsDataSetModule: TDataModule},
  ReservoirKindsFormStubController in 'Controllers\References\Reservoir Kinds\ReservoirKindsFormStubController.pas',
  ReservoirKindReferenceSuitesFormStubController in 'Controllers\References\Reservoir Kinds\ReservoirKindReferenceSuitesFormStubController.pas',
  ReservoirKindFormControllersConfigurator in 'Launching\Configuration\ReservoirKindFormControllersConfigurator.pas',
  FuelCharacteristicsAccountingReferenceFormViewModelMapper in 'View Model Mappers\References\Fuel\FuelCharacteristicsAccountingReferenceFormViewModelMapper.pas',
  ReservoirKindReferenceSuitesViewModelMapper in 'View Model Mappers\References\Reservoir Kinds\ReservoirKindReferenceSuitesViewModelMapper.pas',
  EmployeeDtoMapper in 'DTO Mappers\Cards\Employee\EmployeeDtoMapper.pas',
  EntityDtoMapper in 'C:\Common Delphi Libs\u_59968 Delphi Modules\DDD\Presentation\DTO Mappers\EntityDtoMapper.pas',
  RoleDtoMapper in 'DTO Mappers\Cards\Employee\RoleDtoMapper.pas',
  EmployeeAccountDtoMapper in 'DTO Mappers\Cards\Employee\EmployeeAccountDtoMapper.pas',
  LogOnInfoDtoMapper in 'DTO Mappers\Cards\Employee\LogOnInfoDtoMapper.pas',
  FuelCharacteristicsCalculationCardDtoMapper in 'DTO Mappers\Cards\Fuel\FuelCharacteristicsCalculationCardDtoMapper.pas',
  ReservoirKindReferenceSuiteDtoMapper in 'DTO Mappers\Cards\Reservoir Kinds\ReservoirKindReferenceSuiteDtoMapper.pas',
  FuelCharacteristicsCalculationCardFormServiceController in 'Controllers\Cards\Fuel\FuelCharacteristicsCalculationCardFormServiceController.pas',
  EmployeeAdministrationCardFormServiceController in 'Controllers\Cards\Employees\EmployeeAdministrationCardFormServiceController.pas',
  RoleViewModelMapper in 'View Model Mappers\Cards\Employees\RoleViewModelMapper.pas',
  FuelCharacteristicsAccountingReferenceFormServiceController in 'Controllers\References\Fuel\FuelCharacteristicsAccountingReferenceFormServiceController.pas',
  ZDataSetReader in 'C:\Common Delphi Libs\u_59968 Delphi Modules\Query Executors\DataSet-Based Executors\Zeos-Based\ZDataSetReader.pas',
  ReservoirKindsFormServiceController in 'Controllers\References\Reservoir Kinds\ReservoirKindsFormServiceController.pas',
  ReservoirKindsFormViewModelMapper in 'View Model Mappers\References\Reservoir Kinds\ReservoirKindsFormViewModelMapper.pas',
  ReservoirKindReferenceSuiteCardFormServiceController in 'Controllers\Cards\Reservoir Kinds\ReservoirKindReferenceSuiteCardFormServiceController.pas',
  ReservoirKindReferenceSuitesFormServiceController in 'Controllers\References\Reservoir Kinds\ReservoirKindReferenceSuitesFormServiceController.pas',
  StubSession in 'C:\Common Delphi Libs\u_59968 Delphi Modules\Repositories and Domain\Session\StubSession.pas',
  AuxZeosFunctions in 'C:\Common Delphi Libs\u_59968 Delphi Modules\AuxZeosFunctions\AuxZeosFunctions.pas',
  FuelCharacteristicsAutomaticCalculationFormServiceController in 'Controllers\Cards\Fuel\Calculation\FuelCharacteristicsAutomaticCalculationFormServiceController.pas',
  ReservoirSubLayerKindIdResolver in '..\Application\Business Processes\Fuel Characteristics Accounting\Accounting\Entities\Reservoir Kinds\Resolvers\Interfaces\ReservoirSubLayerKindIdResolver.pas',
  ViewModelReservoirSubLayerKindValueMapper in 'Controllers\Cards\Fuel\Calculation\Mappers\ViewModelReservoirSubLayerKindValueMapper.pas',
  WorkingTimeConditionsCardFormViewModel in 'Forms\Cards\Working Time Conditions\View Models\WorkingTimeConditionsCardFormViewModel.pas',
  WorkingTimeConditionsCardFormViewModelMapper in 'View Model Mappers\Cards\Working Time Conditions\WorkingTimeConditionsCardFormViewModelMapper.pas',
  WorkingTimeConditionsDtoMapper in 'DTO Mappers\Cards\Working Time Conditions\WorkingTimeConditionsDtoMapper.pas',
  unWorkingTimeConditionsCardForm in 'Forms\Cards\Working Time Conditions\unWorkingTimeConditionsCardForm.pas' {WorkingTimeConditionsCardForm},
  BaseWorkingTimeConditionsCardFormController in 'Controllers\Cards\Working Time Conditions\BaseWorkingTimeConditionsCardFormController.pas',
  WorkingTimeConditionsCardFormControllerEvents in 'Controllers\Cards\Working Time Conditions\WorkingTimeConditionsCardFormControllerEvents.pas',
  WorkingTimeConditionsCardFormServiceController in 'Controllers\Cards\Working Time Conditions\WorkingTimeConditionsCardFormServiceController.pas',
  WorkingTimeConditionsCardFormAdministrationServiceController in 'Controllers\Cards\Working Time Conditions\WorkingTimeConditionsCardFormAdministrationServiceController.pas',
  unWorkingTimeConditionsAdministrationCardForm in 'Forms\Cards\Working Time Conditions\unWorkingTimeConditionsAdministrationCardForm.pas' {WorkingTimeConditionsAdministrationCardForm},
  GlobalErrorHandler in 'C:\Common Delphi Libs\u_59968 Delphi Modules\Misceleneous\GlobalErrorHandler.pas';
